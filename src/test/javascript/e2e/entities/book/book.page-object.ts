...
export class BookDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.book.delete.question'));
...
export default class BookComponentsPage {
  ...
  async deleteBook() {
    ...
    expect(await bookDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.book.delete.question/);
