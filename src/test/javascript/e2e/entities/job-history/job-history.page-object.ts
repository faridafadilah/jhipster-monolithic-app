...
export class JobHistoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.jobHistory.delete.question'));
...
export default class JobHistoryComponentsPage {
  ...
  async deleteJobHistory() {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.jobHistory.delete.question/);
