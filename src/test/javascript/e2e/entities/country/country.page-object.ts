...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.country.delete.question/);
