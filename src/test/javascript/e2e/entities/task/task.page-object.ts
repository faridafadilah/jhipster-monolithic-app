...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.task.delete.question/);
