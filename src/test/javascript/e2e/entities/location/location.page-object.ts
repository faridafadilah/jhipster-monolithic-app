...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.location.delete.question/);
