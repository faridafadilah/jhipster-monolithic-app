...
export class DepartmentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.department.delete.question'));
...
export default class DepartmentComponentsPage {
  ...
  async deleteDepartment() {
    ...
    expect(await departmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.department.delete.question/);
