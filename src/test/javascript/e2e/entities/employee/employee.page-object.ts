...
export class EmployeeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.employee.delete.question'));
...
export default class EmployeeComponentsPage {
  ...
  async deleteEmployee() {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.employee.delete.question/);
