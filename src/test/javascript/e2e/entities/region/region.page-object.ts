...
export class RegionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.region.delete.question'));
...
export default class RegionComponentsPage {
  ...
  async deleteRegion() {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.region.delete.question/);
