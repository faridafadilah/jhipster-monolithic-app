...
export class JobDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myappApp.job.delete.question'));
...
export default class JobComponentsPage {
  ...
  async deleteJob() {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myappApp.job.delete.question/);
