...
export class Config {
    ...
    'jhipster.mail.from' = 'myapp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'myapp API';
    'jhipster.swagger.description' = 'myapp API documentation';
    ...
    'eureka.instance.appname' = 'myapp';
    'eureka.instance.instanceId' = 'myapp:${random.value}';
